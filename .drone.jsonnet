...
steps: [
  BuildStepDry('base'),
  BuildStepDry('go-1.12.8', 'dry-run-base'),
  BuildStepDry('go-1.11.13', 'dry-run-base'),

  BuildStep('base'),
  BuildStep('go-1.12.7', 'build-base'),
  BuildStep('go-1.12.8', 'build-base'),
  BuildStep('go-1.12.x', 'build-go-1.12.8'),
  BuildWithDiffTags('go-latest', 'latest', 'build-go-1.12.x'),
  BuildStep('go-1.11.12', 'build-base'),
  BuildStep('go-1.11.13', 'build-base'),
  BuildStep('go-1.11.x', 'build-go-1.11.13'),
]
}
